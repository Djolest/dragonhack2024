    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      <div className="grid text-center mb-0 max-w-6xl grid-cols-2 grid-rows-2 gap-10">
        ...
        <Link
          ...
          className=""
        >
          <h2 className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100mb-3 text-2xl font-semibold text-cyan-500">
            Enter as student{" "}
        ...
        <Link
          ...
          className=""
        >
          <h2 className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 mb-3 text-2xl font-semibold text-cyan-500">
            Enter as tutor{" "}
            <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">
              -&gt;
            </span>
